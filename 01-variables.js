 ...
 * name = 'Eric'; => Success!
 *
 * There are other reasons to use `let` and `const`. If you want to know more
 * you can follow the doc links below. Getting started I would stick with
 * using `const` unless you have a good reason to use `let`.
 *
 * let docs: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/let
 * const docs: https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Statements/const
 *
 *
 * ~> OBJECTIVE:
 *
 * Create a few variables that describe yourself or your favorite hobby
 */
